      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20">
        <div>
          ...
          <p className="text-sm lg:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            GitHub insights within seconds. Just clean data.
          </p>
        </div>
        ...
        <div className="space-y-6">
          {steps.map((step, index) => (
            <div
              key={index}
              className="flex flex-col items-start border-l-4 border-indigo-500 pl-4"
            >
              <span className="text-indigo-500 font-bold text-sm uppercase tracking-widest mb-1">
                {step.keyword}
              </span>
